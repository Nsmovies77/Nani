...
API_ID = int(environ['16675303'])
API_HASH = environ['1fd213d0674a1c4f100049e726065001']
BOT_TOKEN = environ['6364771270:AAESNpEJS1tkGii399kNDQSqU_lmmvMK_gw']
...
auth_channel = environ.get('-1001855383944')
auth_grp = environ.get('-1001519206403')
AUTH_CHANNEL = int(-1001866077051) if auth_channel and id_pattern.search(auth_channel) else None
